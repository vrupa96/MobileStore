	...
	<div class="row">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
                    <i class="fa fa-cogs fa-2x"></i>&nbsp;&nbsp;	<b>Update Category: ${categoryInfo.categoryName}</b></div>
                <div class="panel-body">
                
                    <form id="updateSup" action="<c:url value = "/UpdateCategory"/>" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="catname" class="col-sm-3 control-label">
                            Category Name</label>
                        <div class="col-sm-9">
                            <input type="text" id="catname" name="catname" value="${categoryInfo.categoryName}"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <textarea id="catdesc" name="catdesc"
                            style="max-height: 150px; max-width: 225px; min-width: 225px; min-height: 30px; text-align: left;"  rows="4" cols="30" form="updateSup">${categoryInfo.categoryDesc}
                            </textarea>
                        </div>
                    </div>
